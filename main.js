class QuranApp {
  ...
  async openBookmark() {
    window.overlayManager && window.overlayManager.showBookmarks();
  }
  addBookmark(e) {
  ...
  async loadTafsir() {
    ...
    try {
      ...
      return (
        ...
        (this.tafsirLoaded = !0),
        (this.tafsirLoading = !1),
        this.tafsirLoadQueue.forEach((e) => e(!0)),
        (this.tafsirLoadQueue = []),
      ...
      return (
        (this.tafsirLoaded = !1),
        (this.tafsirLoading = !1),
        this.tafsirLoadQueue.forEach((e) => e(!1)),
        (this.tafsirLoadQueue = []),
...
showPageInputDialog() {
  ...
  setupEventListeners() {
    ...
    const o = (e) => {
      ...
      if (a) return;
      const o = window.quranReader;
      if (o)
        switch (e.key) {
          case "ArrowLeft":
          case "PageDown":
            (e.preventDefault(), o.goToNextPage());
            break;
          case "ArrowRight":
          case "PageUp":
            (e.preventDefault(), o.goToPreviousPage());
            break;
          case "ArrowUp":
            (e.preventDefault(),
              "scroll" === o.readingMode &&
                o.elements.pageScroll?.scrollBy({
                  top: -120,
                  behavior: "smooth",
                }));
            break;
          case "ArrowDown":
            ...
            break;
          case "Home":
            (e.preventDefault(), o.goToFirstPage());
            break;
          case "End":
            (e.preventDefault(), o.goToLastPage());
            break;
        }
    };
