...
class QuranReader {
        ...
        const e = () => {
          this.resizePending ||
            ...
            requestAnimationFrame(() => {
              (this.handleResize(), (this.resizePending = !1));
            }));
        };
  ...
  detectReadingMode() {
    ...
    return (
      window.screen && window.screen.orientation
        ...
        : (this.isPortraitMode = t / e > 1.5714285714285714),
  ...
  setupEventListeners() {
    ...
    if (this.elements.bookmarkBtn) {
      const e = async () => {
        window.quranApp &&
          (await window.quranApp.openBookmark(),
          this.updateBookmarkButton(),
